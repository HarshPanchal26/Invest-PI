    ...
    <div className="bg-white h-auto overflow-auto">
      <header className="absolute inset-x-0 top-0 z-50 bg-white">
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end bg-red-600 p-4 rounded-lg">
      ...
      <div className="relative isolate px-2 pt-30 lg:px-8">
        {/* Intro Section */}
        <div className='mt-10' id='featute-section'>
          <Features />
        </div>
        {/*  Feature Section */}
        <div id='featute2-section'>
          <Feature2 />
        </div>
        {/* Pricing Section */}
