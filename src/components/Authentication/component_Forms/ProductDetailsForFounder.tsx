...
export default function ProductDetailsForFounder() {

  const handleClick = () => {
    // handleNext();
  }
  return (
    <div className='flex md:w-1/2 w-full mx-auto flex-col h-screen my-10'>
      <Logo />
      {/* <div className=''>
        <div className="sm:col-span-3 my-5">
          ...
          <div className="mt-2">
            ...
            />
            <p className="mt-3 text-sm leading-6 text-gray-600">This Email will be used as your login email</p>
          </div>
        </div>
