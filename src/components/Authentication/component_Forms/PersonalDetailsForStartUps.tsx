...
import { PersonalDataVarificationForStartUps } from '../../../Verification/PersonalDataVarification'
...
export default function PersonalDetailsForStartUps({ handleNext ,setObjForSignInComonent }: propsType) {
  ...
  const handleChageInValue = (event: any) => {
    ...
    objForStartups[name] = value;
  }

  const handleClick = async () => {
    console.log("dataForPersonalDetails" , dataForPersonalDetails)
    try {
      await PersonalDataVarificationForStartUps(dataForPersonalDetails);
      let Schema= SchemaForStartupsobj(dataForPersonalDetails);
      ...
      <div className="  pb-12">
        ...
        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div className="col-span-5 md:col-span-4">
            ...
            Link (Link of Website Or Blod Describe your business or product)
            </label>
            <div className="mt-2">
              <input
                type="text"
