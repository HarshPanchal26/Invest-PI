...
import {TypeForMiedia} from '../../../../utils/type'
...
type Props = {
    ArrayForMedia : Array<TypeForMiedia>
}

export default function ViewMedia({ ArrayForMedia }: Props) {
        ...
        <>
            <div className='w-full border-l xl:mt-1 md:mt-15'>
                <ImageList sx={{ width: '80%', height: 450, margin: 'auto' }}>
                    {ArrayForMedia.map((item : TypeForMiedia, index: number) => (
