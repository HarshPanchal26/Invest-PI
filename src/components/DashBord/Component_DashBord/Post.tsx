  ...
  return (
    <>
      {ArrayOfthoughts.map((item : any, index) => {
        return (
          <div className='border-b-2 p-1 w-full md:w-5/6 mx-auto cursor-pointer hover:bg-gray-50 rounded-sm' key={index}>
            <div className=' w-full min-h-[100px] h-auto flex flex-col'>
              <div className=' border-gray-300 flex flex-row '>
                <Avatar alt="Remy Sharp" src="https://encrypted-tbn3.gstatic.com/licensed-image?q=tbn:ANd9GcSX3J6e0wtDpL2nrK3tURbkLzwJ5jNv32_bxuPJxb2W2x1yBQTEiOGkZ2dKh1HsJTjbhqKzLga-smPAxkA" sx={{ width: 40, height: 40 }} className='my-2 mx-2' />
              ...
              <div className='my-1 flex flex-row w-full gap-3'>
                <div className='w-full'>
                  ...
                  >
                    <FavoriteBorderIcon />
                    <span className='mx-2 text-lg'>{'Like'}</span>
                  </IconButton>
                </div>
