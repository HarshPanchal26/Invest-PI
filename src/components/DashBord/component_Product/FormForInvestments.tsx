...
import QueForFundigRoundDetails from './component_Form/QueForFundigRoundDetails';
import QuestionForUseofFunds from './component_Form/QuestionForUseofFunds';
...
export default function FormForInvestments({setDrawerOpen} :props ) {
